...
try:
    ...
    print(json.dumps({"error": "La librería pdfplumber no está instalada en el entorno Python."}))
    sys.exit(1)
...
def parse_pdf(filepath):
    ...
    # Limpiar y parsear cada partida independientemente
    for p in partidas:
        # Asegurarse de que si el PDF dice explícitamente "No Indicado" o vacío se mantenga así.
